...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'name' => 'icon_set',
			'type' => 'repeater',
			'instructions' => 'Create a new set to be used in any given location on the site',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
			...
			'sub_fields' => array (
				array (
					...
					'name' => 'action-name',
					'type' => 'text',
					'instructions' => 'This is the name of the action placed in your theme. <em>For Example: <?php  <strong>MUST BE UNIQUE!</strong>',
					'required' => 1,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
